...
class ValidCodeImg:
    def __init__(self, width=100, height=50, code_count=4, font_size=32, point_count=0, line_count=4,
                 img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype("F://software/typefont/00tt2.ttf", size=self.font_size)
